...
async def start(event):
  await event.reply("**🌀TTK Tagger**\n ile Grubunuzdakı Nerdeyse Tüm Üyelere Etiket Ata bilirim \nKomutlar için =======> /help yazın**",
                    buttons=(
                   
		      [Button.url('Beni Gruba Ekle ➕', 'http://t.me/TTKTaggerBot?startgroup=a')],
                      [Button.url('💬 Söhbət Qrupumuz', 'https://t.me/OSCAR_sohbet')],
                      [Button.url('Resmi Kanal📣', 'https://t.me/TTKResmi3')],
		      [Button.url('Developer👨🏻‍💻', 'https://t.me/VusalAndMe')],
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**🌀 TTK Tagger Komutları**\n\n**/tag <sebeb> - 5-li Etiket Atar**\n\n**/etag <sebeb> - Emoji ile etiketler**\n\n**/tektag sebeb - Üyeleri Tek Tek Etiketler**\n\n**/admins sebeb - Yöneticileri Tek Tek Tag Eder**\n\n**/start - botu başlatır**"
